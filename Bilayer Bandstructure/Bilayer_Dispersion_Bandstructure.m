function Bilayer_Dispersion_Bandstructure
clear
close
m = 1;
n = 1;
...
phase = exp(2*pi*1i/3);
phaseC = conj(phase);
H = [0            vf*(kx-1i*ky) tbar          tbar          tbar*phase              tbar*phaseC             tbar*phaseC                     tbar*phase                      0                       0                       0                               0;
    vf*(kx+1i*ky) 0             tbar          tbar          tbar                    tbar*phase              tbar                            tbar*phaseC                     0                       0                       0                               0;
   
    tbar          tbar          0             vf*(kx-1i*ky) 0                       0                       0                               0                               -tbar*phaseC             -tbar*phase            -tbar*phase                    -tbar*phaseC;
    tbar          tbar          vf*(kx+1i*ky) 0             0                       0                       0                               0                               -tbar                   -tbar*phaseC             -tbar                           -tbar*phase;
    
    tbar*phaseC   tbar          0             0             0                       vf*(kx+G1x-1i*(ky+G1y)) 0                               0                               0                       0                       0                               0;
    tbar*phase    tbar*phaseC   0             0             vf*(kx+G1x+1i*(ky+G1y)) 0                       0                               0                               0                       0                       0                               0;
    
    tbar*phase    tbar          0             0             0                       0                       0                               vf*(kx+G1x+G2x-1i*(ky+G1y+G2y)) 0                       0                       0                               0;
    tbar*phaseC   tbar*phase    0             0             0                       0                       vf*(kx+G1x+G2x+1i*(ky+G1y+G2y)) 0                               0                       0                       0                               0;
    
    0             0             -tbar*phase   -tbar          0                       0                       0                               0                               0                       vf*(kx-G1x-1i*(ky-G1y)) 0                               0;
    0             0             -tbar*phaseC    -tbar*phase   0                       0                       0                               0                               vf*(kx-G1x+1i*(ky-G1y)) 0                       0                               0;
    
    0             0             -tbar*phaseC    -tbar          0                       0                       0                               0                               0                       0                       0                               vf*(kx-G1x-G2x-1i*(ky-G1y-G2y));
    0             0             -tbar*phase   -tbar*phaseC    0                       0                       0                               0                               0                       0                       vf*(kx-G1x-G2x+1i*(ky-G1y-G2y)) 0];
end
